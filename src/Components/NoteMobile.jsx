...
export default function NoteMobile() {
    return (
        <section className="lg:hidden block">
            ...
            <div className="relative min-h-[740px] max-h-[800px] md:min-h-[1200px] py-10">
                ...
                <div className="w-[320px] h-[400px] md:w-[500px] md:h-[650px] absolute bottom-0 right-0 px-10">
